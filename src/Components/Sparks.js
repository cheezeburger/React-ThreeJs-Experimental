...
function Fatline({ curve, width, color, speed }) {
  ...
  return (
    <mesh>
      ...
      <meshLineMaterial attach="material" ref={material} transparent depthTest={false} lineWidth={width} color={color} dashArray={0.9} dashRatio={0.95} />
    </mesh>
  )
}
...
export default function Sparks({ mouse, count, colors, radius = 10 }) {
  ...
  return (
    <group ref={ref}>
      <group position={[-radius * 3, -radius, -10]} scale={[1.7, 1.3, 1]}>
